...
- Privilege escalation across the database roles (`openbrain_app` / `openbrain_ingester` / `openbrain_monitor` / `openbrain_readonly`), or any unintended path to the superuser
