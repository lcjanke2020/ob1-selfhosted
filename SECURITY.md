...
- Privilege escalation across the database roles (`openbrain_app` / `openbrain_ingester` / `openbrain_monitor` / `openbrain_token_admin` / `openbrain_readonly`), or any unintended path to the superuser
