...
> **Connecting a local Codex CLI instead?** That's a different client shape — a public PKCE client with no secret, authorized once per machine. See [`docs/codex-oauth-client.md`](../../docs/codex-oauth-client.md).
