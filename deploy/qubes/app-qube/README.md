...
It records content-free classifier degradation durably; this app qube can then
deliver optional Pushover/ntfy alerts from that ledger. Apply the migration and
run `db/03-grants-assertion.sql` before recreating the MCP container. See
