...
| `openbrain_logs_backup` | SELECT on `funnel_access_summary` only; no raw-table, DML, sequence, database, or schema-creation privilege                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | optional fixed qrexec producer for the encrypted aggregate backup; absent when that backup is not installed                                                                                                                                                                                                                                                                                                                                                    |
...
**separate cluster**: a socket-only Funnel-log sink whose only application data tables are two permanent
