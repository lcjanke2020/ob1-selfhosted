...
- **Configured model endpoints still see sensitive input.** Spaces do not bypass the embedder or classifier; hosted fallbacks must be disabled when content cannot leave the network. ([`spaces.md`](spaces.md#the-seeded-sensitive-space))
