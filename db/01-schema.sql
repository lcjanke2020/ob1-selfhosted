...
-- metadata lives in its separate sink and is not part of this grant surface.
-- Default privileges are preserved so future corpus tables remain inspectable.
--
...
-- created later in 02-observability.sql (mcp_auth_events BIGSERIAL) and any
-- future ones; the one-shot ALL SEQUENCES grant covers a
